...
struct test_case {
    ...
    int expect_schedules_unscaled[MAX_CHILDREN];
    int actual_schedules[MAX_CHILDREN];
    int total_actual_schedules;
    function_type functions[MAX_CHILDREN];
    int override_min_schedules;
};
...
struct test_case tests[] = {
    ...
    },
    {
        ...
        .tickets[1] = 1000,
        .tickets[2] = 1750,
        .expect_schedules_unscaled[0] =  50,
        .expect_schedules_unscaled[1] = 100,
        .expect_schedules_unscaled[2] = 175,
        .functions[0] = yield_forever,
        .functions[1] = yield_forever,
    ...
    },
    {
        ...
        .tickets[1] = 3,
        .tickets[2] = 4,
        .expect_schedules_unscaled[0] = 2,
        .expect_schedules_unscaled[1] = 3,
        .expect_schedules_unscaled[2] = 4,
        .functions[0] = yield_forever,
        .functions[1] = yield_forever,
        .functions[2] = yield_forever,
    },
    ...
    },
    {
        ...
        .tickets[6] = 110,
        .expect_schedules_unscaled[0] =  50,
        .expect_schedules_unscaled[1] =  60,
        .expect_schedules_unscaled[2] =  70,
        .expect_schedules_unscaled[3] =  80,
        .expect_schedules_unscaled[4] =  90,
        .expect_schedules_unscaled[5] = 100,
        .expect_schedules_unscaled[6] = 110,
        .functions[0] = yield_forever,
        .functions[1] = yield_forever,
        .functions[2] = yield_forever,
    ...
    },
    {
        ...
        .tickets[1] = 200,
        .expect_schedules_unscaled[0] =  50,
        .expect_schedules_unscaled[1] =  200,
        .functions[0] = yield_forever,
        .functions[1] = run_forever,
        .override_min_schedules = 70,
    },
    { .name = 0, }
};
...
/* The comapre_schedules() code tries to do a Chi-squared test.
...
int compare_schedules_chi_squared(struct test_case *test) {
    ...
    /*
       compute the expected number of schedules for each child given the total number
